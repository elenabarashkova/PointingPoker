  ...
  <main className={styles.container}>
    <div className={styles.containerSloganField}>
      <p className={styles.slogan}>
        ...
        through
        <span className={styles.markItal}> improvement</span>, one
    ...
    <div className={styles.containerMainField}>
      ...
      <div className={styles.palette}>
        <div className={styles.round}>
          <span className={styles.feature}>plan</span>
        </div>
        <div className={styles.round}>
          <span className={styles.feature}>discuss</span>
        </div>
        <div className={styles.round}>
          <span className={styles.feature}>vote</span>
        </div>
        <div className={styles.round}>
